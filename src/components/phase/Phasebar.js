    ...
    return (
        <>
            ...
            <div className="p-2 flex flex-col items-center">
                <h2 className="text-blue-900 text-lg font-semibold sm:text-3xl">Who Qualifies?</h2>
                <h2 className="text-blue-900 text-xs italic sm:text-base">According to PA DOH</h2>
