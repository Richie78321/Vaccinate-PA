      ...
      <div className="CountySuggestion px-3 mt-5 mb-5 ml-n3 mr-n3  py-4">
        <div className="row">
          ...
          <div className="col-md-6">
            <p>
              Click your county to the left, or use the search above to find
              vaccine information.
            </p>
            <p>
              ...
              of the vaccine rollout. This means we have begun vaccinating those
              most at-risk of illness, such as health care workers and
              Pennsylvanians living in long-term care facilities, persons age 65
              and older, and those age 16-64 with high-risk conditions. See a
              comprehensive list of Pennsylvanians included in each phase here.
            </p>
          </div>
        </div>
      </div>
