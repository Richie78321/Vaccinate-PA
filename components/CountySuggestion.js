      ...
      <div className="container">
        <div className="mx-md-n5 row justify-content-center">
          ...
          <div className="mt-3 mt-md-0 col-md-5">
            ...
            <p>
              As of April 13th, 2021, the Commonwealth of Pennsylvania <a href="https://www.health.pa.gov/topics/disease/coronavirus/Vaccine/Pages/Vaccine.aspx" target="_blank" rel="noreferrer">has
              approved</a> giving the COVID-19 vaccine to all adults.<br />
              Philadelphia is a separate jurisdiction; their eligibility information is available <a href="https://www.phila.gov/programs/coronavirus-disease-2019-covid-19/data/vaccine/" target="_blank" rel="noreferrer">here.</a>
            </p>
            <p>
