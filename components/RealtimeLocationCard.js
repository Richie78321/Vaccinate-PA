...
const PROVIDER_TO_METADATA = {
  albertsons: {
    name: "ACME",
    image: "https://upload.wikimedia.org/wikipedia/commons/8/80/Logo_acme.svg",
  },
  walgreens: {
    name: "Walgreens",
    image:
  ...
  rite_aid: {
    name: "Rite Aid",
    image: "https://upload.wikimedia.org/wikipedia/commons/6/6b/Rite_Aid.svg",
    instructions:
      "https://drive.google.com/file/d/1h2PRp_kNFGGuieq9KIAwIkGYB1ohJYP5/view?usp=sharing",
  },
  sams_club: {
    name: "Sams Club",
    image: "https://upload.wikimedia.org/wikipedia/commons/e/e7/Sams_Club.svg",
  },
  walmart: {
    name: "Walmart",
    image:
      ...
      {address ? (
        <>
          ...
          {location.properties.postal_code && websiteUrl && (
            <small>
              <a href={websiteUrl}>Click here</a> to schedule an appointmment
            ...
            <div className="row">
              <div className="col-auto title-section">
                <div>
                  ...
                  {instructionsLink ? (
                    <a href={instructionsLink} target="_blank" rel="noreferrer">
                      <small>
                        View Scheduling Tips <FaExternalLinkAlt size=".75em" />
                      </small>
                    </a>
                  ) : null}
                </div>
                <div className="realtime-right-card flex">
                  ...
                  <img className="provider-logo" src={logoUrl}></img>
                </div>
              </div>
            </div>
          </li>
