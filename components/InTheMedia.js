  ...
  const media = [
    {
      ...
      title: 'Covid-19 Vaccine Confusion Leads Volunteers to Create Online Guides',
    ...
    },
    {
      ...
      title: 'Pitt students volunteer to create website to help Pennsylvanians find COVID-19 vaccines',
    ...
    },
    {
      ...
      title: "‘It’s ridiculous’: Stressed Pennsylvanians craving easier path to COVID-19 vaccination",
      imagePath: '/images/PittsburghPostGazette.jpg',
      immageAlt: 'Pittsburgh Post Gazette',
    },
    {
      href: 'https://www.abc27.com/news/health/coronavirus/coronavirus-pennsylvania/i-need-to-get-involved-volunteer-run-vaccinatepa-org-helps-pennsylvanians-find-appointments/',
      title: '“I need to get involved” – Volunteer-run VaccinatePA.org helps Pennsylvanians find appointments',
    ...
    {
      href: 'https://pittsburgh.cbslocal.com/2021/02/04/college-students-create-website-coronavirus-vaccine-website/',
      title: 'COVID-19 In Pennsylvania: 3 College Students Create Website For Finding Vaccine',
